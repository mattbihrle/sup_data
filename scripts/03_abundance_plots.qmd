...
colnames(mt_mag_large$tax_table)
...
trans_abund$new(mt_mag_large, taxrank = "f", ntaxa = 50, high_level = "g1_Resource_Acquisition_Substrate_degradation_complex_carbohydrate_depolymerization")$plot_bar(ggnested = TRUE) +
