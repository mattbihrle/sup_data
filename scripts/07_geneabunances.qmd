...
test <- microeco::microtable$new(tax_table = tax_test, otu_table = otu_table_final, sample_table = mt_mag$sample_table)

test$cal_abund(select_cols = c("l1", "l2", "l3", "l4", "ec", "f", "g", "s"))
    t1 <- trans_diff$new(test, method = "lefse", group = "strat_season")
